...
<sql:query dataSource="${dataSource}" var="resultSet">
   SELECT * FROM user_tbl_old WHERE user_id =?
 ...
 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
	...
	<div class="container">
		<form name="newMember"action="processUpdateMember.jsp" method="post" onsubmit="return checkForm()">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" value="<c:out value='${row.user_id }'/>" >
				</div>
			</div>
				<div class="mb-3 row">
				...
				<div class="col-sm-5">
					<input name="address" type="text" class="form-control" placeholder="address" value="<c:out value='${row.user_address}'/>">
				</div>
			</div>
				<div class="mb-3 row">
